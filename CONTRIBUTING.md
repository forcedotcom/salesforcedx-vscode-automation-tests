...
1. Familiarize yourself with the codebase by reading the [docs](docs).
...
1. Verify your e2e test successfully runs against the `develop` branch of https://github.com/forcedotcom/salesforcedx-vscode.
