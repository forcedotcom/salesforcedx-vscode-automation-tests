...
export const templateInfo = [
  '{',
  '  "templateType": "app",',
  '  "label": "sampleAnalyticsTemplate1",',
  '  "name": "sampleAnalyticsTemplate1",',
  '  "description": "",',
  '  "assetVersion": 57.0,',
  ...
  '  "dashboards": [',
  '    {',
  '      "label": "sampleAnalyticsTemplate1Dashboard",',
  '      "name": "sampleAnalyticsTemplate1Dashboard_tp",',
  '      "condition": "${Variables.Overrides.createAllDashboards}",',
  '      "file": "dashboards/sampleAnalyticsTemplate1Dashboard.json"',
  '    }',
  '  ],',
  '  "eltDataflows": [],',
  '  "datasetFiles": [],',
...
export const dashboard = [
  ...
  '  "name": "sampleAnalyticsTemplate1Dashboard_tp",',
  '  "label": "sampleAnalyticsTemplate1Dashboard",',
  '  "description": "sampleAnalyticsTemplate1 dashboard",',
  '  "folder": {',
  '    "id": "${App.Folder.Id}"',
  '  },',
  '  "dateVersion": 1,',
  ...
  '                  "color": "rgb(9, 26, 62)"',
  '                },',
  '                "insert": "sampleAnalyticsTemplate1 Analytics Dashboard"',
  '              },',
  '              {',
  '                "attributes": {',
  '                  "align": "center"',
